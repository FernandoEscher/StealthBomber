...
function NewStick( Props )
        ...
        Group.Shoot = display.newCircle(display.contentWidth - 100, 0, 24)
        Group.Shoot.strokeWidth = 1
        Group.Shoot:setFillColor  (255,255,255,96)
        Group.Shoot:setStrokeColor(255,255,255,255)
        Group.Shoot.x0 = 0
        Group.Shoot.y0 = 0
        Group:insert(Group.Shoot)
        ...
        Group.onDrag = function ( event )
                ...
                -- elseif T.isFocus or Group.Shoot.isFocus then
