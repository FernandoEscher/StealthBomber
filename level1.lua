...
function scene:createScene( event )
	...
	local background1 = display.newImage( "starreduniverse.jpg", display.contentWidth, display.contentHeight )
	background1:setReferencePoint( display.TopLeftReferencePoint )
	background1.x, background1.y = 0, 0

	local background2 = display.newImage( "starreduniverse.jpg", display.contentWidth, display.contentHeight )
	background2:setReferencePoint( display.TopLeftReferencePoint )
	background2.x, background2.y = display.contentWidth, 0
	...
	local warrior = display.newImage( "warrior.png")
	warrior:setReferencePoint( display.TopLeftReferencePoint )

	warrior:scale(0.2, 0.2)
	warrior.x, warrior.y = 20, ((display.contentHeight/2) - ((warrior.height*warrior.yScale)/2))
